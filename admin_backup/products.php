          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form action="" method="post" id="carform" enctype="multipart/form-data" >
                ...
                <div class="form-group has-feedback">
                 <select name="category_id" form="carform">
                  <?php
              ...
              if(isset($_POST['submit']))
              {
                ...
                $q = $obj->insert('productstable', $array);
...
//      var_dump($q);die();
      ...
      if($obj->num($r)> 0)
      {
        $row1 = $obj->fetch($r);
                 ...
                 echo $row1['name']; ?></div>
                <div class="col-md-2"><img src="http://localhost/admin/imagesproducts/<?php echo $row['file']; ?>" width="40px"></div>
               
               
                <div class="col-md-2"><a href="editproducts.php?id=<?php echo $row['id'];?>">Edit</a> / <a href="deleteproducts.php?id=<?php echo $row['id'];?>">Delete</a> </div>
              </div>
                <?php
              }
            }
