...
<section class="mar-top-50px">
 ...
 <section class="latest-blog-large">
	<div class="container-fluid bg-gray">
		<div class="row ">
			<div class="col-lg-12">
				...
				<!--form-->
				<center>
				 <form class="form-inline margin-top" action="" method="POST" id="registerclient">
    <div class="form-group" >
				<div class="row mar-bottom">
					<div class="col-md-6 col-sm-12 col-lg-"><input type="text" class="form-control" name="name" id="name" placeholder="NAME"></div>
					<div class="col-md-6"><select name="gender" form="registerclient" style="    height: 41px;
    width: 192px;">
  ...
  <option value="female">FEMALE</option>
				...
				<div class="row mar-bottom">
					<div class="col-md-6"><input type="email" class="form-control" name="email" id="email" placeholder="EMAIL"></div>
					<div class="col-md-6"><input type="password" class="form-control" name="password" id="password" placeholder="PASSWORD"></div>
