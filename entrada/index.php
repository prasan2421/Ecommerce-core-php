    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 mar-bottom-30px">
          <div class="image-wrapper"><img src="images/tour-38-550x358.jpg" class="img-responsive"><a href="detail.html" class="text-best-seller">
            <h4>PRODUCT 1</h4>
...
<div class="button"><a class="btn btn-lg btn-primary " href="detail.html" role="button">EXPLORE</a></div>            <hr>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 mar-bottom-30px">
          <div class="image-wrapper"><img src="images/tour-37-550x358.jpg" class="img-responsive"><a href="detail.html" class="text-best-seller">
            <h4>PRODUCT 2</h4>
            </a><a href="">City Tours, </a><a href="">Urban</a><br>
            <img src="images/globe-01-512.png"> 12 Countries <img src="images/Icon_World_People-512.png"> 1 Activity
            <hr>
...
<div class="button"><a class="btn btn-lg btn-primary " href="detail.html" role="button">EXPLORE</a></div>            <hr>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 mar-bottom-30px">
          <div class="image-wrapper"><img src="images/tour-36-550x358.jpg" class="img-responsive"><a href="detail.html" class="text-best-seller">
...
<div class="button"><a class="btn btn-lg btn-primary " href="detail.html" role="button">EXPLORE</a></div>            <hr>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 mar-bottom-30px">
          <div class="image-wrapper"><img src="images/tour-36-550x358 (1).jpg" class="img-responsive"><a href="" class="text-best-seller">
            <h4>Boating and Sailing Tours</h4>
            </a><a href="">City Tours, </a><a href="">Urban</a><br>
            <img src="images/globe-01-512.png"> 12 Countries <img src="images/Icon_World_People-512.png"> 1 Activity
            <hr>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 mar-bottom-30px">
          <div class="image-wrapper"><img src="images/tour-24-min-550x358.jpg" class="img-responsive"><a href="" class="text-best-seller">
            <h4>Boating and Sailing Tours</h4>
            </a><a href="">City Tours, </a><a href="">Urban</a><br>
            <img src="images/globe-01-512.png"> 12 Countries <img src="images/Icon_World_People-512.png"> 1 Activity
            <hr>
...
<div class="button"><a class="btn btn-lg btn-primary " href="#" role="button">EXPLORE</a></div>            <hr>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 mar-bottom-30px">
          <div class="image-wrapper"><img src="images/tour-13-min-550x358.jpg" class="img-responsive"><a href="" class="text-best-seller">
            <h4>Boating and Sailing Tours</h4>
            </a><a href="">City Tours, </a><a href="">Urban</a><br>
            <img src="images/globe-01-512.png"> 12 Countries <img src="images/Icon_World_People-512.png"> 1 Activity
            <hr>
  ...
  <div class="padding-top-50px container">
    ...
    <div class="row">
      <div class="col-md-4 col-sm-6 col-xs-12 demo-3">
        <figure><img src="images/tour-03-550x358.jpg" class="img-responsive">
          <figcaption>
            <h2>
              <center>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 demo-3">
        <figure><img src="images/tour-13-min-550x358.jpg" class="img-responsive">
          <figcaption>
            <h2>
              <center>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 demo-3">
        <figure><img src="images/tour-24-min-550x358.jpg" class="img-responsive">
          <figcaption>
            <h2>
              <center>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 demo-3">
        <figure><img src="images/tour-36-550x358.jpg" class="img-responsive">
          <figcaption>
            <h2>
              <center>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 demo-3">
        <figure><img src="images/tour-38-550x358.jpg" class="img-responsive">
          <figcaption>
            <h2>
              <center>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 demo-3">
        <figure><img src="images/product-02-550x358.jpg" class="img-responsive">
          <figcaption>
            <h2>
              <center>
...
<section class="guides mar-bottom-30px">
	...
	<h2><i>Our highly trained and efficient guides at your service</i></h2>
		...
		<div class="row mar-top-30px">
          ...
          <img src="images/guide-03-370x450.jpg" class="img-responsive">
            <div class="overlay">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 mar-bottom-30px"><div class="hovereffect">
            <img src="images/guide-02-370x450.jpg" class="img-responsive">
            <div class="overlay">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 mar-bottom-30px"> <div class="hovereffect">
            <img src="images/guide-01-370x450.jpg" class="img-responsive">
            <div class="overlay">
