...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $cond = "id = '".$id."'";
 $q = $obj->select('moderatortable',$cond);
$row = $obj->fetch($q);
}
              ?>
            ...
            <div class="box-body">
              ...
              <form action="" method="post">
                ...
                <div class="row">
                  ...
                  <!-- /.col -->
                  <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit">Update Member</button>
                  </div>
                  <!-- /.col -->
                </div>
              </form>
              ...
              if (isset($_POST['submit'])) {
                ...
                $id = $_GET['id'];
                $cond = "id='".$id."'";
                $q = $obj->update('moderatortable',$array,$cond);
