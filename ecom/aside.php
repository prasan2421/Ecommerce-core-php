                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="memberlist.php"><i class="fa fa-circle-o"></i> Member List </a></li>
                     <li class="active"><a href="products.php"><i class="fa fa-circle-o"></i> Products </a></li> 
                      ...
                      <li class="active"><a href="contact.php"><i class="fa fa-circle-o"></i> Contact</a></li>
                       <li class="active"><a href="office.php"><i class="fa fa-circle-o"></i> Office</a></li>
                        <li class="active"><a href="textfile.php"><i class="fa fa-circle-o"></i> Upload text file</a></li>
