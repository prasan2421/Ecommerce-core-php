...
if(isset($_GET['id']))
             {
                ...
                if ($obj->num($query)> 0) {
                  while ($row=$obj->fetch($query)) {
                    ?>
<div class="detail-head-left"><div class="col-md-6 col-sm-12 "><img src="http://localhost/admin/imagesproducts/<?php echo $row['file'];?>" style="background: none;    height: 400px;" ></div></div>
  <div class="detail-head-right"><div class="col-md-6 col-sm-12 "><div class="detail-head-info"><div class="detail-head-topic"><h2><b><?php echo 
  $row['name']; ?></b></h2></div><br>
<div class="">
